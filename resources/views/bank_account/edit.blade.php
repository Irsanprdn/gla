        ...
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    ...
                    <input type="text" class="form-control" name="account_number" value="{{ old('account_number', $bankAccount->account_number) }}" required autocomplete="off">
                </div><br>
                <div>
                ...
                <div>
                    ...
                    <input type="text" class="form-control" name="bank_name" value="{{ old('bank_name', $bankAccount->bank_name) }}" required autocomplete="off">
                </div><br>
            </div>
        </div>
    </form>
